...
def test_blocksparse_gpu_outer_opt():
    """
    """
    # As I can see, optimization is failing because SparseBlockOuter
    # is the last op of the graph (so no GpuFromHost after it)
    # and none of its inputs are HostFromGpu. Any solution?
